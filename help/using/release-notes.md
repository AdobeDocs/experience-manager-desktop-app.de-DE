...
* Unterstützung für **Standardauthentifizierung** während AEM- und SSO-Anmeldungen.
* Konfigurierbare Anzahl von Assets, die beim Hochladen zulässig ist.
...
* Um Assets hochzuladen, können Benutzer die Dateien oder Ordner jetzt direkt aus dem Windows Explorer oder Mac Finder in die Benutzeroberfläche des Programms ziehen. Dieser Prozess funktioniert zusätzlich zu der in der Anwendung verfügbaren Upload-Option. Siehe [Upload von Assets](/help/using/using.md#upload-and-add-new-assets-to-aem) <!-- CQ-4309527 -->
